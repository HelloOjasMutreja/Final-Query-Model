...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference("Option.count") do
      post options_url, params: { option: { answer: @option.answer, query_id: @option.query_id } }
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { answer: @option.answer, query_id: @option.query_id } }
